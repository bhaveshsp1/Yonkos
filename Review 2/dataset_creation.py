    ...
    def capture_images(self):
        ...
        while count < 250:
            ...
            for (x, y, w, h) in faces:
                ...
                resized_face = cv2.resize(roi_gray, (255, 255))
                cv2.imwrite(f"{images_folder}/{name}_{count}.jpg", resized_face)
                count += 1
                cv2.putText(frame, f"Captures: {count}/250", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                cv2.waitKey(100)
